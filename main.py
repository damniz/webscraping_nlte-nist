...
if __name__ == "__main__":
    ...
    for i, (nuc_charge, rho, temperature) in enumerate(
        ...
        url = build_url(
            base_url, nuc_charge, rho, temperature, energy_no_1, energy_no_2, opacities
        )
